    ...
    <div class="card-body">
      ...
      <div class="card-footer">
        <div class="stars">
          <i
            v-for="n in 5" :key="n"
            :class="['pi', n <= Math.round(park.rating || 0) ? 'pi-star-fill' : 'pi-star']"
          />
        </div>
...
.fav-btn .pi { font-size: 14px; color: var(--text-muted); transition: color 0.15s; }
...
.card-loc .pi { font-size: 11px; color: var(--forest-mid); }
